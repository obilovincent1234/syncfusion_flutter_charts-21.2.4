...
class WaterfallSeriesRenderer extends XyDataSeriesRenderer {
  ...
  ChartSegment _createSegments(
    ...
    final SegmentProperties segmentProperties = SegmentProperties(
    ...
    if (seriesRendererDetails
        ...
        ZoomPanBehaviorHelper.getRenderingDetails(
              seriesRendererDetails.stateProperties.zoomPanBehaviorRenderer,
            ).isPinching !=
            true &&
      ...
      segmentProperties.oldPoint =
          (oldSeriesRendererDetails.segments.isNotEmpty == true &&
                  ...
                  (oldSeriesRendererDetails.dataPoints.length - 1 >=
                          pointIndex) ==
                      true)
      ...
      for (
        ...
        oldSegment =
            seriesRendererDetails.stateProperties.segments[i]
                as WaterfallSegment;
    ...
    if (seriesRendererDetails.visible! == true) {
      ...
      for (int pointIndex = 0; pointIndex < dataPoints.length; pointIndex++) {
        ...
        if (renderingDetails.templates.isNotEmpty &&
          ...
          renderingDetails.templates[pointIndex].location = Offset(
            point.markerPoint!.x,
            point.markerPoint!.y,
          );
        }
