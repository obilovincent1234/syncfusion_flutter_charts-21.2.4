  ...
  void _drawSegment(Canvas canvas, ChartSegment segment) {
    if (_segmentSeriesDetails.isSelectionEnable == true) {
      ...
      SelectionHelper.getRenderingDetails(
        ...
        _currentSeriesDetails.segments[0],
...
class RangeAreaChartPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (seriesRendererDetails.visible! == true) {
      ...
      oldSeriesRenderer = getOldSeriesRenderer(
        stateProperties,
      ...
      if (oldSeriesRenderer != null) {
        oldSeriesRendererDetails = SeriesHelper.getSeriesRendererDetails(
          oldSeriesRenderer,
        );
      }
      ...
      for (int pointIndex = 0; pointIndex < dataPoints.length; pointIndex++) {
        ...
        if (point.isVisible && !point.isDrop) {
          ...
          currentPointLow = calculatePoint(
            point.xValue,
            point.low,
            xAxisDetails,
            yAxisDetails,
          ...
          currentPointHigh = calculatePoint(
            point.xValue,
            point.high,
            xAxisDetails,
            yAxisDetails,
      ...
      for (
        int pointIndex = dataPoints.length - 2;
        pointIndex >= 0;
        pointIndex--
      ) {
        point = dataPoints[pointIndex];
