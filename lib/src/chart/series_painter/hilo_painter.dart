    ...
    if (seriesRendererDetails.visible! == true) {
      ...
      for (int pointIndex = 0; pointIndex < dataPoints.length; pointIndex++) {
        ...
        if (withInXRange || withInHighLowRange) {
          if (withInXRange) {
            seriesRendererDetails.visibleDataPoints!.add(
          ...
          if (point.high != null && point.low != null) {
            ...
            if (showMarker) {
              ...
              seriesRendererDetails.markerShapes.add(
                getMarkerShapesPath(
              ...
              seriesRendererDetails.markerShapes2.add(
                getMarkerShapesPath(
                  pointMarkerDetails?.markerType ?? markerType,
              ...
              final Paint strokePaint = seriesRendererDetails
                  .markerSettingsRenderer!
                  .getStrokePaint(
                    point,
                    series,
              ...
              final Paint fillPaint = seriesRendererDetails
                  .markerSettingsRenderer!
                  .getFillPaint(
                    point,
                    series,
