  ...
  ChartSegment _createSegments(
    ...
    if (_currentSeriesDetails
        ...
        ZoomPanBehaviorHelper.getRenderingDetails(
              _currentSeriesDetails.stateProperties.zoomPanBehaviorRenderer,
            ).isPinching !=
            true &&
      ...
      segmentProperties.oldPoint =
          (segmentOldSeriesDetails.segments.isNotEmpty == true &&
                  segmentOldSeriesDetails.segments[0] is RangeColumnSegment &&
                  (segmentOldSeriesDetails.dataPoints.length - 1 >=
                          pointIndex) ==
                      true)
      ...
      if ((_currentSeriesDetails.stateProperties.selectedSegments.length - 1 >=
        ...
        selectedSegmentProperties.oldSegmentIndex = getOldSegmentIndex(
          selectedSegment,
        );
      }
      ...
      for (
        ...
        oldSegment =
            _currentSeriesDetails.stateProperties.segments[i]
    ...
    if (borderRadius != null) {
      ...
      if (rangeColumnSeries.isTrackVisible) {
        segmentProperties.trackRect = getRRectFromRect(
          currentPoint.trackerRectRegion!,
          borderRadius,
        );
      }
    }
...
class RangeColumnChartPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (seriesRendererDetails.visible! == true) {
      ...
      animationFactor =
          seriesRendererDetails.seriesAnimation != null
