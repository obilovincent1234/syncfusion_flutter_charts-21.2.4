...
class SeriesRendererDetails {
  ...
  void drawSegment(Canvas canvas, ChartSegment segment) {
    ...
    if (SeriesHelper.getSeriesRendererDetails(
      ...
      SelectionHelper.getRenderingDetails(
        ...
        segments[segment.currentSegmentIndex!],
  ...
  void processData(
    HistogramSeries<dynamic, dynamic> series,
    List<num> yValues,
    num yValuesCount,
  ) {
  ...
  void calculateRegionData(
    ...
    if (withInRange(
      seriesRendererDetails.dataPoints[pointIndex].xValue,
    ...
    if (series.enableTooltip != null &&
      ...
      if (primaryAxisDetails is DateTimeAxisDetails) {
        ...
        date = dateFormat.format(
          DateTime.fromMillisecondsSinceEpoch(point.xValue),
        );
      } else if (primaryAxisDetails is DateTimeCategoryAxisDetails) {
        date = primaryAxisDetails.dateFormat.format(
          DateTime.fromMillisecondsSinceEpoch(point.xValue.floor()),
        );
      }
