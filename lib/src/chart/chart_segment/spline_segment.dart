...
class SplineSegment extends ChartSegment {
  ...
  Paint getStrokePaint() {
    ...
    if (segmentProperties.strokeColor != null) {
      strokePaint.color =
          segmentProperties.pointColorMapper ??
          segmentProperties.strokeColor!.withOpacity(
            segmentProperties.series.opacity,
          );
      strokePaint.color =
          (segmentProperties.series.opacity < 1 == true &&
  ...
  void calculateSegmentPoints() {
    ...
    _axisClipRect = calculatePlotOffset(
      ...
      Offset(
        segmentSeriesRendererDetails.xAxisDetails!.axis.plotOffset,
  ...
  void onPaint(Canvas canvas) {
    ...
    if (segmentSeriesRendererDetails.isSelectionEnable == true) {
      ...
      ).selectionRenderer?.checkWithSelectionState(
    ...
    if (segmentProperties.series.animationDuration > 0 == true &&
      ...
      _oldSegment =
          (currentOldSeriesRendererDetails.segments.length - 1 >=
                      currentSegmentIndex! ==
                  true)
      ...
      if (_oldSegment != null &&
        ...
        if (_oldYAxisRenderer != null && _oldXAxisRenderer != null) {
          ...
          _needAnimate =
              oldYAxisDetails.visibleRange!.minimum !=
      ...
      if (segmentProperties.currentPoint!.isGap != true &&
        ...
        drawDashedLine(
          canvas,
          segmentProperties.series.dashArray,
          strokePaint!,
          path,
        );
      }
